...
public class Xnor extends BinaryExpression {
    ...
    public Expression norify() {
      return new Nor((new Nor((expression1.norify()), (new Nor(expression1.norify(), expression2.norify())))),
              (new Nor((expression2.norify()), (new Nor(expression1.norify(), expression2.norify())))));
    }
    ...
    public Expression simplify() {
        ...
        return new Xnor(simplifiedExpression1, simplifiedExpression2);
    }
}