...
public class Or extends BinaryExpression {
    ...
    public Expression assign(String var, Expression expression) {
        return new Or(expression1.assign(var, expression), expression2.assign(var, expression));
    }

    // Returns the expression tree resulting from converting all the operations to the logical Nand operation.
    public Expression nandify() {
        return new Nand((new Nand(expression1.nandify(), expression1.nandify())),
                (new Nand(expression2.nandify(), expression2.nandify())));
    }

    // Returns the expression tree resulting from converting all the operations to the logical Nor operation.
    public Expression norify() {
        return new Nor((new Nor(expression1.norify(), expression2.norify())),
    ...
    public Expression simplify() {
        ...
        return new Or(simplifiedExpression1, simplifiedExpression2);
    }
}
